...
THINGSBOARD_HOST = '192.168.8.100'

ACCESS_TOKEN = 'IikOek5loculUtkqa2DR'
...
def connect():
    ...
    sensor_data['Ambient Tempurature'] = float(sensor.get_amb_temp())
    sensor_data['Body Tempurature'] = float(sensor.get_obj_temp())
