...
#values = str(values)
config = {
  "apiKey": "AIzaSyApfNVDlnNjRonOn3AD0kmaKsRzJDYTUKI",
  "authDomain": "ecosysteme-f2248.firebaseapp.com",
  "databaseURL": "https://ecosysteme-f2248-default-rtdb.firebaseio.com/",
  "storageBucket": "ecosysteme-f2248.appspot.com",
  "projectId": "ecosysteme-f2248",
  "storageBucket": "ecosysteme-f2248.appspot.com",
  "messagingSenderId": "7803843325",
  "appId": "1:7803843325:web:16759c83ad2aa326bec494",
  "measurementId": "G-KR8T8N9YDV"
}
...
while True:
		...
		database.child("-N29xOZdWYhzrL0zvTxL")
		data = {"model_name": model_name,"memory": memory,"cpu_temp" : float(cpu_temp),"used_space": float(used_space),"cpu_load": cpu_load,"Voltage": float(voltage)* 3 ,"Ambient Tempurature": get_amb,"Body Tempurature": get_obj,"sys_clock_speed": int(sys_clock_speed)}
		database.set(data)
		print(get_obj)
